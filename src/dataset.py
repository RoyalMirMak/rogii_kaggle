...
from src.physics import FormationPlaneKNN, DenseANCCImputer, beam_search, multi_scale_ncc, run_pf_ancc, run_pf_z_velocity, seg_b_well, affine_cal
...
class DatasetBuilder:
    ...
    def _build_features_for_well(self, wid, split, test_eval_idx=None):
        ...
        if has_tw:
            ...
            if self.feature_flags.get("pfz", False):
